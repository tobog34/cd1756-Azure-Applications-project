...
def _build_msal_app(cache=None, authority=None):
    ...
    client_object = msal.ConfidentialClientApplication(Config.CLIENT_ID, client_credential=Config.CLIENT_SECRET,
                                        authority=authority or Config.AUTHORITY, token_cache=cache)
    return client_object

def _build_auth_url(authority=None, scopes=None, state=None):
    # TODO: Return the full Auth Request URL with appropriate Redirect URI
    request_url = _build_msal_app(authority=authority).get_authorization_request_url(scopes=scopes or [],
                                                               redirect_uri=url_for('authorized', _external=True, _scheme='https'),
